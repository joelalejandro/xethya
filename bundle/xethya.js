...
Object.defineProperty(exports, "Eventable", {
  enumerable: true,
  get: function get() {
    return _eventable.default;
  }
});
...
var _eventable = _interopRequireDefault(__webpack_require__(1));
...
function Eventable(target) {
  Object.assign(target.prototype, new _eventemitter.EventEmitter(), _eventemitter.EventEmitter.prototype);
}
...
var _assertionError = _interopRequireDefault(__webpack_require__(4));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function assert(condition, message) {
  if (!condition) {
    throw new _assertionError.default(message);
  }
}
...
function (_Error) {
  ...
  function AssertionError(message) {
    ...
    _this = _possibleConstructorReturn(this, (AssertionError.__proto__ || Object.getPrototypeOf(AssertionError)).call(this));
    _this.message = "[AssertionError] An assertion has failed".concat(message ? ': ' + message : '');
    return _this;
  }
